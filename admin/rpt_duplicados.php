...
<script>
    ...
    {
        window.location= "rpt_duplicados_ex.php?seccion="+sec;
    }
</script>
<form action="index.php" method="GET">
<strong>Buscar Duplicados:</strong>
<select name="seccion">
<?php 
$c = 0;
$s = "";
...
<?php
$flt = "WHERE (SELECT count(nombre) FROM usr_".$seccion." WHERE nombre like a.nombre) > 1";

$r = $mysql_db->query("SELECT a.* FROM usr_".$seccion." as a ".$flt." ORDER BY a.nombre");
